...
8. Première version : nommer les trains dans `notes/trains.yml`, puis `node outils/versionner.mjs promouvoir` sur une branche de sortie (la commande refuse `main`), et poser les tags.
