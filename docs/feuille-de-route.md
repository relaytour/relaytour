...
Cette liste décrit les évolutions envisagées après la première version. Elle ne fixe ni date ni ordre : les organisations qui utilisent Relaytour choisiront les évolutions les plus utiles après une première édition. Chaque organisation garde ses besoins propres (connecteurs, fournisseur d'identité, priorités) hors de ce dépôt.
...
- **Palmarès.** Le score reste privé pendant l'édition, visible par la personne concernée et par les admins. En fin d'édition, l'organisation décide si elle publie un palmarès et sous quelle forme. Chaque personne peut accepter ou refuser d'y figurer.
- **Bilan d'édition.** Les admins obtiennent un bilan par périmètre : tâches réalisées, tâches abandonnées, retards, fiches créées ou modifiées. Les référentes et référents ajoutent un retour d'expérience libre, repris l'édition suivante.
