...
fr:
  ...
  texte: >-
    ...
    organisateur avec l'adresse et le code déjà remplis, et la connexion
    part aussitôt. Auparavant, seul le code était rempli, et l'adresse
    seulement si elle avait été saisie dans le même onglet.
---
